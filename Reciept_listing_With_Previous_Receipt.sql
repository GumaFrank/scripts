...
--select distinct  V_RECEIPT_NO, V_SOURCE_REF_NO  from Remt_Receipt where  V_RECEIPT_NO ='HO240001617'
/*
AUTHOR: Frank Bagambe
Date: 18-NOV-2024
Description:   it was a projection requirement from Joyce Nalusiba to added
an Instrument Date to the report, and the previous receipt that was canceled 
*/
  ...
  SELECT Rct.V_Branch_Code,
         ...
         V_SOURCE_REF_NO previous_reciept,
