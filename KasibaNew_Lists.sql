--select *  FROM Remt_Receipt where V_RECEIPT_STATUS ='RE002'
--V_RECEIPT_CODE ='RCT002'
--SELECT * FROM Relu_Cancellation_Reason
...
SELECT
   ...
   -- B.V_CURRENT_STATUS,
    ...
    A.V_CANCELLATION_REASON,
   (SELECT V_REASON_DESC FROM Relu_Cancellation_Reason WHERE V_REASON_CODE=A.V_CANCELLATION_REASON
   AND A.V_RECEIPT_STATUS ='Cancelled') Cancellation_description
FROM 
    (
