...
A new column Classification is added using the DECODE function.
It checks the value of V_PLAN_CODE and assigns "Investment product" if it matches any of the specified codes
(BJIP001-B, BJIP006, BJIP007, BJIP001, BJIP003), and "Traditional product" otherwise.
